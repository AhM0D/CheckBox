...
public abstract class CheckView extends View {
	...
	abstract protected float getStrokeWidth();
	...
	protected void initCheckView() {
		...
		mPaint = createPaint(getCheckColor(), getStrokeWidth());
		eraser = createPaint(getBackGroundColor(), getStrokeWidth());
	}
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		if (changed) {
			...
			mCircleRect.left = mDrawingRect.left + getStrokeWidth() / 2f;
			mCircleRect.top = mDrawingRect.top + getStrokeWidth() / 2f;
			mCircleRect.right = mDrawingRect.right - getStrokeWidth() / 2f;
			mCircleRect.bottom = mDrawingRect.bottom - getStrokeWidth() / 2f;
	...
	public void checkIconInCheckView() {
		mChecked = true;
		ValueAnimator mCheckAnimator = ValueAnimator.ofFloat(0, 1);
